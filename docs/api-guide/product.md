...
{"errorCode":500,"errorMessage":"Unable to save category due to errors:\n- Field error in object 'Product' on field 'category': rejected value [null]; codes [Product.category.nullable.error.Product.category,Product.category.nullable.error.category,Product.category.nullable.error.Category,Product.category.nullable.error,product.category.nullable.error.Product.category,product.category.nullable.error.category,product.category.nullable.error.Category,product.category.nullable.error,Product.category.nullable.Product.category,Product.category.nullable.category,Product.category.nullable.Category,Product.category.nullable,product.category.nullable.Product.category,product.category.nullable.category,product.category.nullable.Category,product.category.nullable,nullable.Product.category,nullable.category,nullable.Category,nullable]; arguments [category,Product]; default message [Property [{0}] of class [{1}] cannot be null]\n"}
```
