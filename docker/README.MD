...
### Prerequisites
1. Install [Docker](https://docs.docker.com/) and [Docker Compose](https://docs.docker.com/compose/) (we support Docker Engine v24 or later)
...
5. Look in `docker-compose`'s logs for `Grails application running at http:/...../openboxes in environment: production` and connect to that URL
