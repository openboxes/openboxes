...
class Transaction implements Comparable, Serializable {
    ...
    def publishSaveEvent = {
        Holders.grailsApplication.mainContext.publishEvent(new TransactionEvent(this, forceRefresh))
    }

    def publishDeleteEvent = {
        Holders.grailsApplication.mainContext.publishEvent(new TransactionEvent(this, true))
    }
