...
//		SupplierType SUPPLIER_OTHER = new SupplierType(name: "Other", description: "Other").save();
		...
		Product advil = new DrugProduct(upc:"AD00001VIL", productCode:"00001", name:"Advil 200mg", genericName: "Ibuprofen", productType: PRODUCT_MEDS_OTHER, weight: 1.6).save(flush:true);
		...
		Product tylenol = new DrugProduct(upc:"TY00006LENOL",productCode:"00006", name: "Tylenol 325mg", genericName: "Ibuprofen", productType: PRODUCT_MEDS_OTHER, weight: 1.1).save(flush:true);		
		...
		Product aspirin = new DrugProduct(upc:"AS00007PIRIN",productCode:"00007", name: "Aspirin 20mg", genericName: "Ibuprofen", productType: PRODUCT_MEDS_OTHER, weight: 1.2).save(flush:true);
		...
		Product generic = new DrugProduct(upc:"GENERAL00008PAIN", productCode:"00008", name: "General Pain Reliever", genericName: "Ibuprofen", productType: PRODUCT_MEDS_OTHER, weight: 1.3).save(flush:true)
		...
		*/
		...
		Product didanosine = new DrugProduct(upc: "DIDAN00009OSINE", productCode:"00009", name:"Didanosine 200mg", productType: PRODUCT_MEDS_OTHER).save(flush:true);		
