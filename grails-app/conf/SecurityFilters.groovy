...
class SecurityFilters {
    ...
    static ArrayList controllersWithAuthUserNotRequired = ['test', 'errors', 'gpsApi']
    ...
    static ArrayList controllersWithLocationNotRequired = ['categoryApi', 'productApi', 'genericApi', 'api', 'gpsApi']
