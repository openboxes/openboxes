    		...
    		<table class="zebra">
                ...
                <%--
                    <tr>
                        ...
                        <td>
                            <img src="${resource(dir:'images/icons/indent.gif')}" class="middle"/>
                        ...
                        <td class="right">
                            <div id="outOfStockCountClassA"><img class="spinner" src="${resource(dir:'images/spinner.gif')}" class="middle"/></div>
                    ...
                    <tr>
                        ...
                        <td class="right">
                            <div id="outOfStockCountClassB"><img class="spinner" src="${resource(dir:'images/spinner.gif')}" class="middle"/></div>
                    ...
                    <tr>
                        ...
                        <td class="right">
                            <div id="outOfStockCountClassC"><img class="spinner" src="${resource(dir:'images/spinner.gif')}" class="middle"/></div>
                ...
                <%--
                    <tr>
                        ...
                        <td class="right">
                            <div id="outOfStockCountClassNone"><img class="spinner" src="${resource(dir:'images/spinner.gif')}" class="middle"/></div>
