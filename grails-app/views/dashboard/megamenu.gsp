    ...
    <g:hideIfIsNonInventoryManagedAndCanSubmitRequest>
        <g:if test="${megamenuConfig.dashboard.enabled}">
            <g:isUserInRole roles="[RoleType.ROLE_BROWSER]">
                <li class="nav-item d-flex justify-content-center align-items-center" id="dashboard">
        ...
        <g:if test="${megamenuConfig.inventory.enabled}">
            ...
            <g:supports activityCode="${ActivityCode.MANAGE_INVENTORY}">
                <li class="nav-item dropdown d-flex justify-content-center align-items-center" id="inventory">
                    <a href="javascript:void(0)" class="nav-link dropdown-toggle">
        ...
        <g:if test="${megamenuConfig.requisitions.enabled}">
            ...
            <g:supports activitiesAny="[ActivityCode.PLACE_REQUEST,ActivityCode.FULFILL_REQUEST]">
                <li class="nav-item dropdown d-flex justify-content-center align-items-center" id="requisitions">
                    <a href="javascript:void(0)" class="nav-link dropdown-toggle">
        ...
        <g:if test="${megamenuConfig.purchasing.enabled}">
            <g:isUserInRole roles="[RoleType.ROLE_BROWSER]">
            <li class="nav-item dropdown d-flex justify-content-center align-items-center" id="purchasing">
                <a href="javascript:void(0)" class="nav-link dropdown-toggle">
        ...
        <g:if test="${megamenuConfig.invoicing.enabled}">
            <g:hasRoleInvoice>
                <li class="nav-item dropdown d-flex justify-content-center align-items-center" id="invoicing">
                    <a href="javascript:void(0)" class="nav-link dropdown-toggle">
        ...
        <g:if test="${megamenuConfig.stockRequest.enabled}">
            <g:hasHighestRoleAuthenticated>
                <li class="nav-item dropdown d-flex justify-content-center align-items-center" id="inbound">
                    <a href="javascript:void(0)" class="nav-link dropdown-toggle">
        ...
        <g:if test="${megamenuConfig.outbound.enabled}">
            ...
            <g:supports activityCode="${ActivityCode.SEND_STOCK}">
                <li class="nav-item dropdown d-flex justify-content-center align-items-center" id="outbound">
                    <a href="javascript:void(0)" class="nav-link dropdown-toggle">
        ...
        <g:if test="${megamenuConfig.reporting.enabled}">
            <g:isUserInRole roles="[RoleType.ROLE_BROWSER]">
            <li class="nav-item dropdown d-flex justify-content-center align-items-center" id="reporting">
                <a href="javascript:void(0)" class="nav-link dropdown-toggle">
        ...
        <g:if test="${megamenuConfig.products.enabled}">
            <g:isUserInRole roles="[RoleType.ROLE_BROWSER]">
            <g:supports activityCode="${ActivityCode.MANAGE_INVENTORY}">
                <li class="nav-item dropdown d-flex justify-content-center align-items-center" id="products">
                    <a href="javascript:void(0)" class="nav-link dropdown-toggle">
        ...
        <g:if test="${megamenuConfig.requisitionTemplate.enabled}">
            <g:isUserInRole roles="[RoleType.ROLE_BROWSER]">
            <li class="nav-item dropdown d-flex justify-content-center align-items-center" id="stocklists">
                <a href="javascript:void(0)" class="nav-link dropdown-toggle">
