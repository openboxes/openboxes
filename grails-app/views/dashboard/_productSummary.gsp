		...
		<div id="alertSummary" class="list">
    		...
    		<table class="zebra">
    			...
    			<tbody>
                    ...
                    <tr>
                        <td class="center" style="width: 1%">
                        <img src="${resource(dir:'images/icons/silk/heart.png')}" class="middle" title='${warehouse.message(code:"inventory.information.label",default:"Information")}'/>
                        </td>
                        <td>
                        ...
                        <td class="right">
                        <div id="healthyStockCount"><img class="spinner" src="${resource(dir:'images/spinner.gif')}" class="middle"/></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="center" style="width: 1%">
                    ...
                    <tr>
                        <td class="center" style="width: 1%">
                            <img src="${resource(dir:'images/icons/silk/exclamation.png')}" class="middle" title='${warehouse.message(code:"inventory.warnings.label",default:"Warning")}'/>
                        </td>
                        <td class="indent">
                ...
                <tr>
                    <td class="center" style="width: 1%">
                        <img src="${resource(dir:'images/icons/silk/stop.png')}" class="middle" title='${warehouse.message(code:"inventory.alerts.label",default:"Critical")}'/>
                    </td>
                    <td>
                ...
                <tfoot>
                    ...
                    <tr>
                        <th class="center" style="width: 1%">
                            <img src="${resource(dir:'images/icons/silk/sum.png')}" class="middle" title='${warehouse.message(code:"inventory.information.label",default:"information")}'/>
                        </th>
                        <th>
