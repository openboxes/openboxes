	                ...
	                <div class="dialog">
	                    <table>
	                        <tbody>
	                            ...
	                            <tr class="prop">
	                                <td valign="top" class="name">
	                                  <label for="categories"><g:message code="category.categories.label" default="Categories" /></label>
	                                </td>
...
<g:link controller="category" action="create" params="['category.id': categoryInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'category.label', default: 'Category')])}</g:link>
	                        ...
	                        --%>
	                            <tr class="prop">
	                                <td valign="top" class="name">
	                                  <label for="parents"><g:message code="category.parents.label" default="Parents" /></label>
	                                </td>
