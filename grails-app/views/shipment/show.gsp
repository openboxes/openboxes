    ...
    <body>
        <div class="body" style="width:100%;">
						...
						<td align="left">
							...
							<span style="">
								<g:if test="${shipmentInstance?.name}">					
									<span style="font-size: 2em; font-weight: bold;">${shipmentInstance?.name}</span>
									<span style="padding-left: 5px; color:#aaa"><g:if test="${shipmentInstance?.identifier}">${shipmentInstance?.identifier}</g:if></span>		
								</g:if>
							</span>
						</td>
						<td align="right" style="text-align: right;">
							<span style="font-size: 2em; color: ${shipmentInstance.shipmentStatus.color}"> 
			...
			<div id="shipment" style="border: 1px solid black;">									            
				<table class="withoutBorder" border="0" style="border-bottom: 1px solid black;">
                    <tbody> 		                    
                    	<tr>
							<td width="35%">
								<div class="tab">
									<table class="withoutBorder" >
										<tbody>
					                        <tr class="prop">
					                            <td valign="top" class="address" nowrap="nowrap" style="border-top: 1px solid #ccc; padding-bottom: 30px;">
					                        ...
					                        <tr class="prop">
					                            <td valign="top" class="address" style="border-top: 1px solid #ccc; padding-bottom: 30px;">
                    		...
                    		<td style="border-left: 1px solid black;">
								<div id="detailsTab" class="tab">
									<table class="withoutBorder" style="border-top: 1px solid #ccc;">
										<tbody>
					                        <tr class="prop">
					                        	<td>					                        
													<div style="color:#ccc; ">Shipment Details:</div>
									            	<div id="view-details" style="background-color: white; padding: 10px;">				            		
														<table class="withoutBorder" cellspacing="5" cellpadding="5">		   
															<tbody>                 			
																...
																<g:each in="${shipmentInstance.referenceNumbers}" var="referenceNumber" status="status">
																	<tr class="prop">
																		<td valign="top" class="name">
																			<label>${referenceNumber?.referenceNumberType?.name}</label>
																		</td>   
																		<td valign="top" class="value">
										                            ...
										                            <td valign="top" class="value">
										                            	...
										                            	<g:if test="${shipmentInstance?.trackingNumber}">
											                            	...
											                            	(<a href="${fieldValue(bean: shipmentInstance, field: "shipmentMethod.trackingUrl")}${fieldValue(bean: shipmentInstance, field: "trackingNumber")}" 
											                            		target="_blank">track</a>)	<span style="color:#aaa">Format: ${shipmentInstance?.shipmentMethod.trackingFormat}</span>
										                            	</g:if>
										                            	<g:else>
																	...
																	<tr class="prop">		                        
											                        	...
											                        	<td>
																			<div class="buttons">
																				...
																				<a href="#" id="edit-details-link" class="negative"> <img src="${createLinkTo(dir:'images/icons/silk',file:'cancel.png')}" alt="" /> Cancel </a>
																			</div>
																		</td>		                        
											                        </tr>													
																</tbody>
												...
												<td>
													<div class="tab">
														<a href="#" id="edit-details-link" ><img src="${createLinkTo(dir:'images/icons/silk',file:'page_edit.png')}" alt="Edit"/></a>
													</div>
												</td>
											</tr>
										</tbody>
		        ...
		        <div>
		            <div id="details">
						<gui:tabView id="shipmentTabs">										
							<gui:tab id="shipmentPiecesTab" label="Pieces" active="true">
								<div id="itemsTab" class="tab">
									...
									<g:else>
									    <g:each in="${shipmentInstance.containers}" var="container" status="c">
										    <table class="container" style="background-color: white; width: 75%" border="0">
												<tbody>
													<tr>
														<td valign="top">
															                    ...
															                    <table class="withBorder">
															                       	<thead>
															                       		<tr>
															                       			...
															                       			<th width="5%" style="text-align: center"><img src="${createLinkTo(dir:'images/icons',file:'trash.png')}" alt="Delete"/></th>
															                       		</tr>
															                       	</thead>
																					<tbody>
																		...
																		<tr>
																			<td style="text-align: center">
																				<g:form action="addItem">
																			    	...
																			    	<b>-or-</b> &nbsp;
																			    	<a href="#" id="add-item-link-${container?.id}">add a donated item</a>																							    	
																				</g:form>																    																								
																			</td>
																		</tr>																												
																	</tbody>
