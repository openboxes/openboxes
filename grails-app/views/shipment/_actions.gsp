			...
			<div class="action-menu-item">		
				<g:if test="${!shipmentInstance?.hasShipped()}">
					<g:link controller="shipment" action="sendShipment" id="${shipmentInstance.id}">
						...
						<g:if test="${request.request.requestURL.toString().contains('sendShipment')}">
				...
				<g:else>
					...
					<a href="javascript:void(0);" onclick="alert('${message}')">
						<img src="${createLinkTo(dir:'images/icons',file:'truck.png')}" alt="Send Shipment" class="middle" />&nbsp; 					
						<span class="fade">
							<warehouse:message code="shipping.sendShipment.label"/>
						</span>
					</a>
			...
			<div class="action-menu-item">
				<g:if test="${shipmentInstance.hasShipped() && !shipmentInstance.wasReceived()}">
					<g:link controller="shipment" action="receiveShipment" id="${shipmentInstance.id}">
						...
						<g:if test="${request.request.requestURL.toString().contains('receiveShipment')}">
