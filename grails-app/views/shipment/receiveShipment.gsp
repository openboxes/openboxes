                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: left;"><warehouse:message code="default.comment.label" /></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <g:each var="receiptItem" in="${receiptInstance?.receiptItems?.sort() }" status="i">
                                                ...
                                                <tr class="prop ${(i % 2) == 0 ? 'odd' : 'even'} ${lastContainer!=shipmentItem?.container?'top':'' }">
                                                    ...
                                                    <td style="text-align: center;" class="middle">
                                                        <g:textField class="text" name="receiptItems[${i}].comment" value="${receiptItem?.comment}" size="40"/>
                                                    </td>
                                                </tr>
