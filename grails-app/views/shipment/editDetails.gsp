...
<head>
	...
	<content tag="pageTitle">
		...
		<span style="color: #aaa; font-size: 0.8em; padding-left: 20px;"><br/>
					...
					<table>
						<tbody>
							<tr class="prop">
								...
								${shipmentInstance?.shipmentNumber}</td>
							</tr>
							<tr class="prop">
								<td valign="top" class="name"><label><g:message
							...
							<tr class="prop">
								...
								<td valign="top"
									...
									nowrap="nowrap"><g:jqueryDatePicker name="expectedShippingDate"
