...
<body>
    ...
    <div>
        <g:if test="${requisitionItemsColdChain}">
            ...
            <g:render template="/picklist/page" model="[pageTitle: pageTitle, requisitionItems:requisitionItemsColdChain, location: location, picklist:picklist, pageBreakAfter: (requisitionItemsControlled||requisitionItemsHazmat||requisitionItemsOther)?'always':'avoid']"/>
        </g:if>
        <g:if test="${requisitionItemsControlled}">
            ...
            <g:render template="/picklist/page" model="[pageTitle: pageTitle,requisitionItems:requisitionItemsControlled, location: location, picklist:picklist, pageBreakAfter: (requisitionItemsHazmat||requisitionItemsOther)?'always':'avoid']"/>
        </g:if>
        <g:if test="${requisitionItemsHazmat}">
            ...
            <g:render template="/picklist/page" model="[pageTitle: pageTitle,requisitionItems:requisitionItemsHazmat, location: location, picklist:picklist, pageBreakAfter: (requisitionItemsOther)?'always':'avoid']"/>
        </g:if>
        <g:if test="${requisitionItemsOther}">
            ...
            <g:render template="/picklist/page" model="[pageTitle: pageTitle,requisitionItems:requisitionItemsOther, location: location, picklist:picklist, pageBreakAfter: (requisitionItemsCanceled)?'always':'avoid']"/>
        </g:if>
        <g:if test="${requisitionItemsCanceled}">
            ...
            <g:render template="/picklist/page" model="[pageTitle: pageTitle,requisitionItems:requisitionItemsCanceled, location: location, picklist:picklist, pageBreakAfter: 'avoid']"/>
        </g:if>
    </div>
</div>
