            ...
            <div class="box">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><warehouse:message code="locationRole.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: locationRoleInstance, field: "id")}</td>
