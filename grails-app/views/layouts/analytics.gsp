...
<head>
    ...
    <%--
    <link rel="stylesheet" href="${resource(dir:'js/datepicker/css', file:'datepicker.css')}">
    --%>
    ...
    <%--
    <script src="${resource(dir:'js/datepicker/js', file:'bootstrap-datepicker.js')}" type="text/javascript" ></script>
    --%>
