                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="transaction" action="edit" id="${transactionEntryInstance?.transaction?.id}">${transactionEntryInstance?.transaction?.encodeAsHTML()}</g:link></td>
