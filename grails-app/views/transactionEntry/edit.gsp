...
<head>
    ...
    <title><warehouse:message code="${transactionEntryInstance?.id ? 'default.edit.label' : 'default.create.label'}"
...
<div class="body">
    ...
    <div class="dialog">
        <g:render template="../transaction/summary"
                  model="[transactionInstance: transactionEntryInstance?.transaction]"/>

        <div id="edit-transaction-entry">
            <div class="yui-gf">
                <div class="yui-u first">
                    <g:render template="../transaction/details"
                              model="[transactionInstance: transactionEntryInstance?.transaction]"/>
                </div>

                <div class="yui-u">
                    <g:form url="[resource: transactionEntryInstance, action: 'update']" method="PUT">
                        <div class="box">
                                ...
                                <table>
                                    ...
                                    <tr class="prop">
                                        <td valign="top" class="name">
                                            <label for="transaction.id"><warehouse:message
                                                    code="transactionEntry.transaction.label"
                                                    default="Transaction"/></label>
                                        </td>
                                        <td valign="top"
                                            class="value ${hasErrors(bean: transactionEntryInstance, field: 'transaction', 'errors')}">
                                            <g:hiddenField name='transaction.id'
                                                           value='${transactionEntryInstance?.transaction?.id}'/>

                                            <g:link controller="transaction" action="edit" id="${transactionEntryInstance?.transaction?.id}">
                                    ...
                                    <tr class="prop">
                                        <td valign="top" class="name">
                                            <label for="product"><warehouse:message code="product.label"
                                    ...
                                    <tr class="prop">
                                        <td valign="top" class="name">
                                            <label for="inventoryItem.id"><warehouse:message
                                                    code="transactionEntry.inventoryItem.label"
                                                    default="Inventory Item"/></label>
                                        </td>
                                        <td valign="top"
                                    ...
                                    <tr class="prop">
                                        <td valign="top" class="name">
                                            <label for="quantity"><warehouse:message
                                                    code="transactionEntry.quantity.label" default="Quantity"/></label>
                                        </td>
                                        <td valign="top"
                                    ...
                                    <tr class="prop">
                                        <td valign="top" class="name">
                                            <label for="comments"><warehouse:message
                                                    code="transactionEntry.comments.label" default="Comments"/></label>
                                        </td>
                                        <td valign="top"
                                            class="value ${hasErrors(bean: transactionEntryInstance, field: 'comments', 'errors')}">
                                            <g:textArea name="comments" cols="40" rows="5"
                                                        value="${transactionEntryInstance?.comments}"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="prop">
                                        ...
                                        <td valign="top">
                                            <div class="">
                                                ...
                                                &nbsp;
                                                <g:link controller='inventory' action='showTransaction'
                                                        id='${transactionEntryInstance?.transaction?.id}'>
