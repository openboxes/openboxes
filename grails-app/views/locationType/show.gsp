...
<html>
    ...
    <body>
        ...
        <div id="show-locationType" class="content scaffold-show" role="main">
            ...
            <f:display bean="locationType" />
            <g:form resource="${this.locationType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.locationType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
