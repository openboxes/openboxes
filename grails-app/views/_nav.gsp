<img src="${resource(dir:'images/icons/silk',file:'package.png')}" alt="Product" /> &nbsp;
	...
	<tr>
		<td>
			<g:each in="${productTypes}" status="i" var="productType">
				...
				<g:if test="${selected }">
					<img src="${resource(dir:'images/icons/silk',file: 'bullet_go.png')}" style="vertical-align: middle;"/>
				</g:if>
				<g:else>
					<img src="${resource(dir:'images/icons/silk',file: 'bullet_white.png')}" style="vertical-align: middle;"/>
				</g:else>
