...
--%>
<div class="summary">
    <span class="title"><warehouse:message code="errors.generalError.label" default="General Error"/></span>
    <div class="right">
...
<div class="message">
    ...
    <g:else>
        <div class="">
            <p>${raw(warehouse.message(code: 'email.errorReportDisabled.message'))}</p>
        </div>
    </g:else>
...
<script>
    function checkFormSubmission() {
        ...
        if (!comments) {
            $("#errors").html("<li>Please describe your bug, including steps to reproduce and any other pertinent information you can gather.</li>").addClass("errors");
            return false;
        }
        return true;
    }
