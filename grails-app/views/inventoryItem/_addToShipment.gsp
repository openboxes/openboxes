...
<div id="dlgAddToShipment-${itemInstance?.id}" title="Add to Shipment" style="padding: 10px; display: none;" >	
	<table>
		<tr>
			<td>
				<g:form controller="inventoryItem" action="addToShipment">
					...
					<table>
						<tbody>
							...
							<tr class="prop">
								<td valign="top" class="name"><label>and <g:message code="shipmentItem.recipient.label" default="Recipient" /></label></td>                            
								<td valign="top" class="value">
