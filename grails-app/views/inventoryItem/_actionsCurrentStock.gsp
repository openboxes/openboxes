<div class="action-menu">
    <g:isUserManager>
        ...
        <div class="actions">
            ...
            <g:render template="editItemDialog" model="[inventoryInstance:inventoryInstance, binLocation:binLocation, itemInstance:itemInstance, itemQuantity: itemQuantity]"/>
            <g:render template="adjustStock" model="[inventoryInstance:inventoryInstance, binLocation:binLocation, itemInstance:itemInstance, itemQuantity: itemQuantity]" />
            <g:render template="transferStock" model="[inventoryInstance:inventoryInstance, binLocation:binLocation, itemInstance:itemInstance, itemQuantity: itemQuantity]" />
            <g:render template="returnStock" model="[inventoryInstance:inventoryInstance, binLocation:binLocation, itemInstance:itemInstance, itemQuantity: itemQuantity]" />
            <g:render template="addToShipment" model="[inventoryInstance:inventoryInstance, binLocation:binLocation, itemInstance:itemInstance, itemQuantity: itemQuantity]" />
        </div>
    </g:isUserManager>
</div>
