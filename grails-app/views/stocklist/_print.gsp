            ...
            <tr>
                ...
                <td colspan="2" class="b-0">
                    <table class="no-border-table">
                        <tr>
                            <td>
                                <img class="logo" src="${stocklist?.origin?.logo ? createLink(controller:'location', action:'viewLogo', id:stocklist?.origin?.id, absolute: true) : createLinkTo(dir: 'images/', file: 'hands.jpg', absolute: true)}"/>
                            </td>
                            <td>
