	...
	<table border="0" width="50%" style="border: 3px solid lightgrey">
		<tr>
			<td class="center ${state.equals('processOrderItems')?'selected':''}">
				<g:link action="receiveOrder" event="processOrderItems">1. Select items to receive </g:link>
			</td>
			<td class="center ${state.equals('enterShipmentDetails')?'selected':''}" >
				<g:link action="receiveOrder" event="enterShipmentDetails">2. Enter shipment details</g:link>
			</td>
