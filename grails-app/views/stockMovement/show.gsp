                            ...
                            <td class="value">
                                <g:if test="${stockMovement?.dateRequested}">
                                    <span title="${g.formatDate(date:stockMovement?.dateRequested)}">
                                        <g:formatDate
                                                formatName="${DateFormatName.FULL_MONTH.property}"
                        ...
                        <tr class="prop">
                            ...
                            <td class="value">
                                <g:if test="${stockMovement?.shipment?.hasShipped()}">
                                    <span title="${g.formatDate(date: stockMovement?.dateShipped, formatName: DateFormatName.FULL_MONTH.property)}">
                                        <g:formatDate
                                                formatName="${DateFormatName.FULL_MONTH.property}"
                            ...
                            <td class="value">
                                <g:if test="${stockMovement?.shipment?.receipts}">
                                    <g:each var="receipt" in="${stockMovement?.shipment?.receipts}">
                                        <span title="${g.formatDate(date: receipt?.actualDeliveryDate, formatName: DateFormatName.FULL_MONTH.property)}">
                                            <g:formatDate
                                                    formatName="${DateFormatName.FULL_MONTH.property}"
                        ...
                        <tr class="prop">
                            ...
                            <td class="value">
                                <g:if test="${stockMovement?.dateCreated}">
                                    <span title="${g.formatDate(date: stockMovement?.dateCreated, formatName: DateFormatName.FULL_MONTH.property)}">
                                        <g:formatDate
                                                formatName="${DateFormatName.FULL_MONTH.property}"
                        ...
                        <tr class="prop">
                            ...
                            <td class="value">
                                <g:if test="${stockMovement?.lastUpdated}">
                                    <span title="${g.formatDate(date: stockMovement?.lastUpdated, formatName: DateFormatName.FULL_MONTH.property)}">
                                        <g:formatDate
                                                formatName="${DateFormatName.FULL_MONTH.property}"
