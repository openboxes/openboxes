    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="list">
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="ean" title="${message(code: 'product.upc.label', default: 'Universal Product Code')}" />
			    ...
			    <th><g:message code="product.action.label" default="Details" /></th>
			    <th><g:message code="product.action.label" default="Stock" /></th>
                        </tr>
                    </thead>
                    <tbody>
                    <g:each in="${productInstanceList}" status="i" var="productInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>
			      <g:link action="show" id="${productInstance.id}">See Details</g:link>
			    </td>
			    <td>
