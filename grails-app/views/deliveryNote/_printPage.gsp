        ...
        <tbody>
            ...
            <g:each in="${requisitionItems}" status="i" var="requisitionItem">
                <g:if test="${picklist}">
                    ...
                    <g:set var="numInventoryItem" value="${shipmentItems ? shipmentItems.size() : (inventoryItemMap?.size() ?: 1)}"/>
                </g:if>
                <g:else>
                    <g:set var="numInventoryItem" value="${shipmentItems ? shipmentItems.size() : 1}"/>
                </g:else>
