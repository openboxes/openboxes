            ...
            var dataTable = $('#dataTable').dataTable( {
                ...
                "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                    ...
                    if (aData["inventoryLevelId"]) {
                        $('td:eq(3)', nRow).html('<a href="${request.contextPath}/inventoryLevel/edit/' + aData["inventoryLevelId"] + '" target="_blank">' + aData["minQuantity"] + '</a>');
                        $('td:eq(4)', nRow).html('<a href="${request.contextPath}/inventoryLevel/edit/' + aData["inventoryLevelId"] + '" target="_blank">' + aData["reorderQuantity"] + '</a>');
                        $('td:eq(5)', nRow).html('<a href="${request.contextPath}/inventoryLevel/edit/' + aData["inventoryLevelId"] + '" target="_blank">' + aData["maxQuantity"] + '</a>');
                    }
                    return nRow;
                }
            });
