    ...
    <body>
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${drugProductInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="brandNames"><g:message code="drugProduct.brandNames.label" default="Brand Names" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: drugProductInstance, field: 'brandNames', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="categories"><g:message code="drugProduct.categories.label" default="Categories" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: drugProductInstance, field: 'categories', 'errors')}">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: drugProductInstance, field: 'conditionTypes', 'errors')}">
