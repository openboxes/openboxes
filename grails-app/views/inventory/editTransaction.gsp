			...
			<div class="dialog" >
				...
				<div class="yui-ga">
					<div class="yui-u first">
                        ...
                        <div class="tabs">
                            <ul>
                                <li><a href="#tabs-header"><warehouse:message
                                        code="transaction.header.label"
                                        default="Transaction Header"/></a></li>
                                <li><a href="#tabs-details"><warehouse:message
                                        code="transaction.details.label"
                                        default="Transaction Details"/></a></li>
                            </ul>
                            <div id="tabs-header">
                                <div class="box">
                                    <h2>${warehouse.message(code: 'transaction.header.label', default: 'Transaction Header')}</h2>
                                    <g:form action="saveTransaction">
                                        ...
                                        <table>
                                            ...
                                            <tr class="prop">
                                                ...
                                                <td class="value">
                                                    <g:selectInventory name="inventory.id" value="${transactionInstance?.inventory?.id}" class="chzn-select-deselect"
                                                                       noSelection="['null': '']" />
                                                </td>
                                            </tr>
                                            <tr class="prop">
                            ...
                            <div id="tabs-details">
                                <div class="box">
                                    <h2>${warehouse.message(code: 'transaction.details.label', default: 'Details')}</h2>
                                    <g:form action="saveTransaction">
                                        <g:hiddenField name="id" value="${transactionInstance?.id}"/>
                                            ...
                                            <table id="transaction-entries-table" border="0" style="margin: 0; padding: 0; border: 0px solid lightgrey; background-color: white;">
                                                ...
                                                <g:each var="transactionEntry" in="${transactionInstance?.transactionEntries }" status="i">
                                                    ...
                                                    <tr class="${i % 2 ? 'odd' : 'even' }">
                                                        ...
                                                        <td>
                                                            <g:link controller="inventoryItem" action="showStockCard" id="${transactionEntry?.inventoryItem?.product?.id}">
                                                        ...
                                                        <td class="center">
                                                            ${quantityMap[transactionEntry?.inventoryItem?.id] }
                                                        </td>
                                                        <td class="center">
