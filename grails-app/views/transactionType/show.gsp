...
<html>
    ...
    <body>
        ...
        <div id="show-transactionType" class="content scaffold-show" role="main">
            ...
            <f:display bean="transactionType" />
            <g:form resource="${this.transactionType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.transactionType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
