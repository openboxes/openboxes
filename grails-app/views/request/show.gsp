	                    ...
	                    <tbody>
	                        <tr class="prop">
	                            <td valign="top" class="name">
	                            	<label for='description'><g:message code="request.description.label" default="Description" /></label>
	                            </td>
	                        ...
	                        <%--
							<tr class="prop">
	                            <td valign="top" class="name"><label><g:message code="request.items.label" default="Shipments" /></label></td>
	                            <td valign="top" class="value">	    
	                     ...
	                     --%>
	                        <tr class="prop">
	                            <td valign="top" class="name"><label for="comments"><g:message code="request.comments.label" default="Comments" /></label></td>
	                            <td valign="top" class="value">
	                        ...
	                        <tr class="prop">
	                            <td valign="top" class="name">
	                            	<label for="comments"><g:message code="request.documents.label" default="Documents" /></label>
	                            </td>                            
	                            <td valign="top" class="value">
