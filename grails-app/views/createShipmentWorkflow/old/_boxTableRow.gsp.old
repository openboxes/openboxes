<tr class="" style="border: 1px solid lightgrey;">
	...
	<td nowrap="nowrap">
		<g:link action="createShipment" event="deleteBox" params="['box.id':boxInstance?.id]" onclick="return confirm('${warehouse.message(code:'shipping.confirm.deleteBox.message')')">
