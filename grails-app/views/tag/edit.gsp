            ...
            <div class="yui-ga">
                <div class="yui-u first">
                    ...
                    <div class="tabs tabs-ui">
                        <ul>
                            <li><a href="#tabs-tag"><warehouse:message code="tag.label"/></a></li>
                            <%-- Only show these tabs if the product has been created --%>
                            <g:if test="${tagInstance?.id }">
                                <li><a href="#tabs-products"><warehouse:message code="products.label"/></a></li>
                            </g:if>
                        </ul>
                        <div id="tabs-tag" class="ui-tabs-hide">
                        ...
                        <div id="tabs-products" class="ui-tabs-hide">
                            <div class="dialog box">
                                <h2><warehouse:message code="tag.products.label" default="Products" /> <small>${tagInstance?.products?.size()} <g:message code="products.label"/></small></h2>
                                        ...
                                        <tbody>
                                            <tr class="prop">
                                                <td valign="top" class="value ${hasErrors(bean: tagInstance, field: 'products', 'errors')}">
                                                    <table id="products">
                                                        <tr>
                                                            <th class="center middle"><g:checkBox id="selectAllProducts" name="selectAllProducts"/></th>
