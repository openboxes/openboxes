    ...
    def edit() {
        ...
        switch (stockMovementDirection) {
            ...
            case StockMovementDirection.INBOUND:
                String step = (stockMovement.statusCode in [StockMovementStatusCode.CREATED, StockMovementStatusCode.REQUESTING]) ?  InboundWorkflowState.ADD_ITEMS : InboundWorkflowState.SEND_SHIPMENT
