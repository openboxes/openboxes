databaseChangeLog = {
    ...
    changeSet(author: "jmiranda (generated)", id: "1613884772808-627") {
        createView("""select `stock_movement_item`.`id` AS `id`,`stock_movement_item`.`requisition_item_type` AS `requisition_item_type`,`stock_movement_item`.`parent_requisition_item_id` AS `parent_requisition_item_id`,`stock_movement_item`.`requisition_id` AS `requisition_id`,`stock_movement_item`.`origin_id` AS `origin_id`,`stock_movement_item`.`destination_id` AS `destination_id`,`stock_movement_item`.`product_id` AS `product_id`,`stock_movement_item`.`product_code` AS `product_code`,`stock_movement_item`.`name` AS `name`,`stock_movement_item`.`quantity` AS `quantity`,`stock_movement_item`.`quantity_canceled` AS `quantity_canceled`,`stock_movement_item`.`quantity_revised` AS `quantity_revised`,`stock_movement_item`.`order_index` AS `sort_order`,`stock_movement_item`.`cancel_reason_code` AS `cancel_reason_code`,`stock_movement_item`.`comments` AS `comments`,`product_summary`.`quantity_on_hand` AS `quantity_on_hand`,`product_stocklist`.`quantity_demand` AS `quantity_demand`,(case when isnull(`product_substitution_status`.`substitution_status`) then 'NO' else `product_substitution_status`.`substitution_status` end) AS `substitution_status` from (((`obgm`.`stock_movement_item` left join `obgm`.`product_stocklist` on(((`product_stocklist`.`product_id` = `stock_movement_item`.`product_id`) and (`product_stocklist`.`origin_id` = `stock_movement_item`.`origin_id`)))) left join `obgm`.`product_summary` on(((`product_summary`.`product_id` = `stock_movement_item`.`product_id`) and (`product_summary`.`location_id` = `stock_movement_item`.`origin_id`)))) left join `obgm`.`product_substitution_status` on(((`product_substitution_status`.`product_id` = `stock_movement_item`.`product_id`) and (`product_substitution_status`.`location_id` = `stock_movement_item`.`origin_id`))))""", fullDefinition: "false", remarks: "", viewName: "edit_page_item")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-628") {
        createView("""select `r`.`id` AS `id`,`r`.`status` AS `status`,`ri`.`quantity` AS `quantity`,`ri`.`quantity_canceled` AS `quantity_canceled`,`ri`.`cancel_reason_code` AS `cancel_reason_code`,`ri`.`requisition_item_type` AS `requisition_item_type`,`obgm`.`product`.`id` AS `product_id`,`obgm`.`product`.`product_code` AS `product_code`,`obgm`.`product`.`name` AS `product_name`,`t`.`transaction_date` AS `transaction_date`,month(`t`.`transaction_date`) AS `month`,year(`t`.`transaction_date`) AS `year`,`origin`.`id` AS `origin_id`,`origin`.`name` AS `origin_name`,`destination`.`id` AS `destination_id`,`destination`.`name` AS `destination_name`,(case when (`il`.`status` = 'FORMULARY') then TRUE else FALSE end) AS `formulary`,(case when ((`ri`.`quantity_canceled` > 0) and (`ri`.`cancel_reason_code` in ('STOCKOUT','LOW_STOCK','COULD_NOT_LOCATE'))) then 0 else 1 end) AS `fill_rate` from ((((((`obgm`.`requisition` `r` join `obgm`.`requisition_item` `ri` on((`r`.`id` = `ri`.`requisition_id`))) join `obgm`.`location` `origin` on((`origin`.`id` = `r`.`origin_id`))) join `obgm`.`location` `destination` on((`destination`.`id` = `r`.`destination_id`))) join `obgm`.`product` on((`obgm`.`product`.`id` = `ri`.`product_id`))) left join `obgm`.`transaction` `t` on((`t`.`requisition_id` = `r`.`id`))) left join `obgm`.`inventory_level` `il` on(((`il`.`inventory_id` = `origin`.`inventory_id`) and (`il`.`product_id` = `obgm`.`product`.`id`)))) where ((`ri`.`requisition_item_type` = 'ORIGINAL') and (`r`.`status` = 'ISSUED'))""", fullDefinition: "false", remarks: "", viewName: "fill_rate")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-629") {
        createView("""(select `a`.`product_code` AS `product_code`,`a`.`name` AS `name`,`a`.`destination_id` AS `destination_id`,(sum(`a`.`quantity_ordered`) - sum(`a`.`quantity_shipped`)) AS `quantity_ordered_not_shipped`,NULL AS `quantity_shipped_not_received` from (select `obgm`.`product`.`product_code` AS `product_code`,`obgm`.`product`.`name` AS `name`,`obgm`.`order_item`.`id` AS `id`,`obgm`.`order`.`destination_id` AS `destination_id`,sum(distinct (case when (`obgm`.`order`.`status` <> 'PENDING') then (`obgm`.`order_item`.`quantity` * `obgm`.`order_item`.`quantity_per_uom`) else 0 end)) AS `quantity_ordered`,sum((case when `obgm`.`shipment_item`.`quantity` then `obgm`.`shipment_item`.`quantity` else 0 end)) AS `quantity_shipped`,NULL AS `quantity_shipped_not_received` from (((((`obgm`.`order_item` join `obgm`.`product` on((`obgm`.`order_item`.`product_id` = `obgm`.`product`.`id`))) join `obgm`.`order` on((`obgm`.`order_item`.`order_id` = `obgm`.`order`.`id`))) left join `obgm`.`order_shipment` on((`obgm`.`order_shipment`.`order_item_id` = `obgm`.`order_item`.`id`))) left join `obgm`.`shipment_item` on((`obgm`.`order_shipment`.`shipment_item_id` = `obgm`.`shipment_item`.`id`))) left join `obgm`.`shipment` on((`obgm`.`shipment_item`.`shipment_id` = `obgm`.`shipment`.`id`))) where ((`obgm`.`order`.`order_type_code` = 'PURCHASE_ORDER') and (`obgm`.`order_item`.`order_item_status_code` <> 'CANCELED')) group by `obgm`.`product`.`product_code`,`obgm`.`order_item`.`id`,`obgm`.`product`.`name`,`obgm`.`order`.`destination_id`) `a` group by `a`.`product_code`,`a`.`name`,`a`.`destination_id`)""", fullDefinition: "false", remarks: "", viewName: "on_order_order_item_summary")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-630") {
        createView("""(select `c`.`product_code` AS `product_code`,`c`.`name` AS `name`,`c`.`destination_id` AS `destination_id`,NULL AS `quantity_ordered_not_shipped`,(sum(`c`.`quantity_shipped`) - (sum(`c`.`quantity_received`) + sum(`c`.`quantity_canceled`))) AS `quantity_shipped_not_received` from (select `obgm`.`product`.`product_code` AS `product_code`,`obgm`.`product`.`name` AS `name`,`obgm`.`shipment_item`.`id` AS `id`,`obgm`.`shipment`.`destination_id` AS `destination_id`,sum(distinct `obgm`.`shipment_item`.`quantity`) AS `quantity_shipped`,sum((case when (`obgm`.`receipt`.`receipt_status_code` = 'RECEIVED') then `obgm`.`receipt_item`.`quantity_received` else 0 end)) AS `quantity_received`,sum((case when ((`obgm`.`receipt`.`receipt_status_code` = 'RECEIVED') and `obgm`.`receipt_item`.`quantity_canceled`) then `obgm`.`receipt_item`.`quantity_canceled` else 0 end)) AS `quantity_canceled` from ((((`obgm`.`shipment_item` join `obgm`.`product` on((`obgm`.`product`.`id` = `obgm`.`shipment_item`.`product_id`))) join `obgm`.`shipment` on((`obgm`.`shipment`.`id` = `obgm`.`shipment_item`.`shipment_id`))) left join `obgm`.`receipt_item` on(((`obgm`.`shipment_item`.`id` = `obgm`.`receipt_item`.`shipment_item_id`) and (`obgm`.`shipment_item`.`product_id` = `obgm`.`receipt_item`.`product_id`)))) left join `obgm`.`receipt` on((`obgm`.`receipt`.`id` = `obgm`.`receipt_item`.`receipt_id`))) where (`obgm`.`shipment`.`current_status` in (NULL,'SHIPPED','PARTIALLY_RECEIVED')) group by `obgm`.`product`.`product_code`,`obgm`.`product`.`name`,`obgm`.`shipment_item`.`id`,`obgm`.`shipment`.`destination_id`) `c` where ((`c`.`quantity_received` + `c`.`quantity_canceled`) < `c`.`quantity_shipped`) group by `c`.`product_code`,`c`.`name`,`c`.`destination_id`)""", fullDefinition: "false", remarks: "", viewName: "on_order_shipment_item_summary")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-631") {
        createView("""(select `a`.`product_code` AS `product_code`,`a`.`name` AS `name`,`a`.`destination_id` AS `destination_id`,`a`.`quantity_ordered_not_shipped` AS `quantity_ordered_not_shipped`,`b`.`quantity_shipped_not_received` AS `quantity_shipped_not_received` from (`obgm`.`on_order_order_item_summary` `a` left join `obgm`.`on_order_shipment_item_summary` `b` on(((`a`.`product_code` = `b`.`product_code`) and (`a`.`destination_id` = `b`.`destination_id`))))) union (select `b`.`product_code` AS `product_code`,`b`.`name` AS `name`,`b`.`destination_id` AS `destination_id`,`a`.`quantity_ordered_not_shipped` AS `quantity_ordered_not_shipped`,`b`.`quantity_shipped_not_received` AS `quantity_shipped_not_received` from (`obgm`.`on_order_shipment_item_summary` `b` left join `obgm`.`on_order_order_item_summary` `a` on(((`b`.`product_code` = `a`.`product_code`) and (`b`.`destination_id` = `a`.`destination_id`)))))""", fullDefinition: "false", remarks: "", viewName: "on_order_summary")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-632") {
        createView("""select `tmp2`.`request_id` AS `request_id`,`tmp2`.`request_status` AS `request_status`,`tmp2`.`request_number` AS `request_number`,`tmp2`.`date_created` AS `date_created`,`tmp2`.`date_requested` AS `date_requested`,`tmp2`.`date_issued` AS `date_issued`,`tmp2`.`origin_id` AS `origin_id`,`tmp2`.`origin_name` AS `origin_name`,`tmp2`.`destination_id` AS `destination_id`,`tmp2`.`destination_name` AS `destination_name`,`tmp2`.`request_item_id` AS `request_item_id`,`tmp2`.`product_id` AS `product_id`,`tmp2`.`product_code` AS `product_code`,`tmp2`.`product_name` AS `product_name`,`tmp2`.`quantity_requested` AS `quantity_requested`,`tmp2`.`quantity_canceled` AS `quantity_canceled`,`tmp2`.`quantity_approved` AS `quantity_approved`,`tmp2`.`quantity_modified` AS `quantity_modified`,`tmp2`.`quantity_picked` AS `quantity_picked`,`tmp2`.`cancel_reason_code` AS `cancel_reason_code`,`tmp2`.`cancel_comments` AS `cancel_comments`,`tmp2`.`pick_reason_code` AS `pick_reason_code`,`tmp2`.`request_item_status` AS `request_item_status`,`tmp2`.`reason_code_classification` AS `reason_code_classification`,(case when (`tmp2`.`request_item_status` = 'SUBSTITUTION') then 'ITEM_SUBSTITUTED' when ((`tmp2`.`quantity_requested` = `tmp2`.`quantity_canceled`) and (`tmp2`.`quantity_picked` = 0)) then 'ITEM_CANCELED' when ((`tmp2`.`quantity_requested` = `tmp2`.`quantity_approved`) and (`tmp2`.`quantity_picked` <> `tmp2`.`quantity_approved`)) then 'PICK_MODIFIED' when ((`tmp2`.`quantity_requested` <> `tmp2`.`quantity_approved`) and (`tmp2`.`quantity_picked` = `tmp2`.`quantity_approved`)) then 'ITEM_MODIFIED' when (`tmp2`.`quantity_picked` > 0) then 'ITEM_ISSUED' else NULL end) AS `request_item_change_status`,(case when (`tmp2`.`request_item_status` = 'SUBSTITUTION') then `tmp2`.`quantity_requested` when (`tmp2`.`quantity_picked` > `tmp2`.`quantity_requested`) then `tmp2`.`quantity_picked` when ((`tmp2`.`quantity_picked` < `tmp2`.`quantity_requested`) and (`tmp2`.`reason_code_classification` in (NULL,'INSUFFICIENT_QUANTITY_AVAILABLE'))) then `tmp2`.`quantity_requested` when ((`tmp2`.`quantity_picked` < `tmp2`.`quantity_requested`) and (`tmp2`.`reason_code_classification` = 'CLINICAL_JUDGMENT')) then `tmp2`.`quantity_picked` else `tmp2`.`quantity_requested` end) AS `quantity_demand` from (select `tmp1`.`request_id` AS `request_id`,`tmp1`.`request_item_id` AS `request_item_id`,`tmp1`.`request_status` AS `request_status`,`tmp1`.`request_number` AS `request_number`,`tmp1`.`date_created` AS `date_created`,`tmp1`.`date_requested` AS `date_requested`,`tmp1`.`date_issued` AS `date_issued`,`tmp1`.`origin_id` AS `origin_id`,`tmp1`.`origin_name` AS `origin_name`,`tmp1`.`destination_id` AS `destination_id`,`tmp1`.`destination_name` AS `destination_name`,`tmp1`.`product_id` AS `product_id`,`tmp1`.`product_code` AS `product_code`,`tmp1`.`product_name` AS `product_name`,`tmp1`.`quantity_requested` AS `quantity_requested`,ifnull(`tmp1`.`quantity_canceled`,0) AS `quantity_canceled`,ifnull(`tmp1`.`quantity_approved`,0) AS `quantity_approved`,ifnull(`tmp1`.`quantity_modified`,0) AS `quantity_modified`,ifnull(`tmp1`.`quantity_picked`,0) AS `quantity_picked`,`tmp1`.`cancel_reason_code` AS `cancel_reason_code`,`tmp1`.`cancel_comments` AS `cancel_comments`,`tmp1`.`pick_reason_code` AS `pick_reason_code`,`tmp1`.`reason_code_classification` AS `reason_code_classification`,`tmp1`.`request_item_status` AS `request_item_status` from (select `obgm`.`requisition`.`id` AS `request_id`,`obgm`.`requisition_item`.`id` AS `request_item_id`,`obgm`.`requisition`.`status` AS `request_status`,`obgm`.`requisition`.`request_number` AS `request_number`,`obgm`.`requisition`.`date_created` AS `date_created`,`obgm`.`requisition`.`date_requested` AS `date_requested`,`requisition_transaction`.`date_issued` AS `date_issued`,`origin`.`id` AS `origin_id`,`origin`.`name` AS `origin_name`,`destination`.`id` AS `destination_id`,`destination`.`name` AS `destination_name`,`child_request_item`.`status` AS `request_item_status`,`obgm`.`product`.`id` AS `product_id`,`obgm`.`product`.`product_code` AS `product_code`,`obgm`.`product`.`name` AS `product_name`,`obgm`.`requisition_item`.`cancel_reason_code` AS `cancel_reason_code`,(case when (`reason_codes`.`insufficient_quantity_available` = TRUE) then 'INSUFFICIENT_QUANTITY_AVAILABLE' when (`reason_codes`.`clinical_judgment` = TRUE) then 'CLINICAL_JUDGMENT' else NULL end) AS `reason_code_classification`,`reason_codes`.`insufficient_quantity_available` AS `insufficient_quantity_available`,`reason_codes`.`clinical_judgment` AS `clinical_judgment`,`obgm`.`requisition_item`.`cancel_comments` AS `cancel_comments`,`obgm`.`requisition_item`.`pick_reason_code` AS `pick_reason_code`,`obgm`.`requisition_item`.`quantity` AS `quantity_requested`,`obgm`.`requisition_item`.`quantity_canceled` AS `quantity_canceled`,`obgm`.`requisition_item`.`quantity_approved` AS `quantity_approved`,(select sum(`child`.`quantity`) from `obgm`.`requisition_item` `child` where ((`child`.`parent_requisition_item_id` = `obgm`.`requisition_item`.`id`) and (`child`.`requisition_item_type` = 'QUANTITY_CHANGE'))) AS `quantity_modified`,`picked_items`.`quantity_picked` AS `quantity_picked` from (((((((((`obgm`.`requisition_item` join `obgm`.`product` on((`obgm`.`product`.`id` = `obgm`.`requisition_item`.`product_id`))) join `obgm`.`requisition` on((`obgm`.`requisition`.`id` = `obgm`.`requisition_item`.`requisition_id`))) join `obgm`.`location` `destination` on((`destination`.`id` = `obgm`.`requisition`.`destination_id`))) join `obgm`.`location` `origin` on((`origin`.`id` = `obgm`.`requisition`.`origin_id`))) join `obgm`.`location_type` on((`origin`.`location_type_id` = `obgm`.`location_type`.`id`))) left join (select `obgm`.`requisition`.`id` AS `requisition_id`,`obgm`.`transaction`.`transaction_date` AS `date_issued` from ((`obgm`.`requisition` join `obgm`.`shipment` on((`obgm`.`shipment`.`requisition_id` = `obgm`.`requisition`.`id`))) join `obgm`.`transaction` on((`obgm`.`shipment`.`id` = `obgm`.`transaction`.`outgoing_shipment_id`)))) `requisition_transaction` on((`obgm`.`requisition`.`id` = `requisition_transaction`.`requisition_id`))) left join (select ifnull(`obgm`.`requisition_item`.`parent_requisition_item_id`,`obgm`.`requisition_item`.`id`) AS `requisition_item_id`,sum(`obgm`.`picklist_item`.`quantity`) AS `quantity_picked` from (`obgm`.`picklist_item` join `obgm`.`requisition_item` on((`obgm`.`picklist_item`.`requisition_item_id` = `obgm`.`requisition_item`.`id`))) group by `obgm`.`requisition_item`.`id`) `picked_items` on((`picked_items`.`requisition_item_id` = `obgm`.`requisition_item`.`id`))) left join (select `obgm`.`requisition_item`.`id` AS `requisition_item_id`,group_concat(distinct `child`.`product_id` separator ',') AS `products`,ifnull(group_concat(distinct `child`.`requisition_item_type` separator ','),`obgm`.`requisition_item`.`requisition_item_type`) AS `status` from (`obgm`.`requisition_item` left join `obgm`.`requisition_item` `child` on((`child`.`parent_requisition_item_id` = `obgm`.`requisition_item`.`id`))) group by `obgm`.`requisition_item`.`id`) `child_request_item` on((`obgm`.`requisition_item`.`id` = `child_request_item`.`requisition_item_id`))) left join (select `parent_item`.`id` AS `requisition_item_id`,sum(if(((`parent_item`.`cancel_reason_code` in ('STOCKOUT','LOW_STOCK','COULD_NOT_LOCATE')) or (`parent_item`.`pick_reason_code` in ('STOCKOUT','LOW_STOCK','COULD_NOT_LOCATE')) or (`child_item`.`cancel_reason_code` in ('STOCKOUT','LOW_STOCK','COULD_NOT_LOCATE')) or (`child_item`.`pick_reason_code` in ('STOCKOUT','LOW_STOCK','COULD_NOT_LOCATE')) or (`parent_picklist_item`.`reason_code` in ('STOCKOUT','LOW_STOCK','COULD_NOT_LOCATE')) or (`child_picklist_item`.`reason_code` in ('STOCKOUT','LOW_STOCK','COULD_NOT_LOCATE'))),TRUE,FALSE)) AS `insufficient_quantity_available`,sum((coalesce(`parent_item`.`cancel_reason_code`,`child_item`.`cancel_reason_code`,`parent_item`.`pick_reason_code`,`child_item`.`pick_reason_code`,`parent_picklist_item`.`reason_code`,`child_picklist_item`.`reason_code`) <> '')) AS `clinical_judgment` from (((`obgm`.`requisition_item` `parent_item` left join `obgm`.`requisition_item` `child_item` on((`child_item`.`parent_requisition_item_id` = `parent_item`.`id`))) left join `obgm`.`picklist_item` `parent_picklist_item` on((`parent_item`.`id` = `parent_picklist_item`.`requisition_item_id`))) left join `obgm`.`picklist_item` `child_picklist_item` on((`child_item`.`id` = `child_picklist_item`.`requisition_item_id`))) group by `parent_item`.`id`) `reason_codes` on((`obgm`.`requisition_item`.`id` = `reason_codes`.`requisition_item_id`))) where ((`obgm`.`requisition_item`.`requisition_item_type` = 'ORIGINAL') and (`obgm`.`location_type`.`location_type_code` = 'DEPOT') and (`obgm`.`requisition`.`status` = 'ISSUED'))) `tmp1`) `tmp2`""", fullDefinition: "false", remarks: "", viewName: "product_demand")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-633") {
        createView("""(select `obgm`.`product`.`id` AS `product_id`,`obgm`.`product`.`product_code` AS `product_code`,`obgm`.`product`.`name` AS `product_name`,`obgm`.`location`.`id` AS `location_id`,`obgm`.`location`.`name` AS `location_name`,(case when (`product_inventory_pivot_view`.`current_quantity` <= 0) then 'out_of_stock' when ((`product_inventory_pivot_view`.`current_quantity` <= `obgm`.`inventory_level`.`min_quantity`) and (`obgm`.`inventory_level`.`min_quantity` <> 0)) then 'low_stock' when ((`product_inventory_pivot_view`.`current_quantity` <= `obgm`.`inventory_level`.`reorder_quantity`) and (`obgm`.`inventory_level`.`reorder_quantity` <> 0)) then 'reorder_stock' when ((`product_inventory_pivot_view`.`current_quantity` >= `obgm`.`inventory_level`.`max_quantity`) and (`obgm`.`inventory_level`.`max_quantity` <> 0)) then 'over_stock' else 'in_stock' end) AS `status`,coalesce(`obgm`.`inventory_level`.`min_quantity`,0) AS `min_quantity`,coalesce(`obgm`.`inventory_level`.`reorder_quantity`,0) AS `reorder_quantity`,coalesce(`obgm`.`inventory_level`.`max_quantity`,0) AS `max_quantity`,`product_inventory_pivot_view`.`previous_quantity` AS `previous_quantity`,`product_inventory_pivot_view`.`current_quantity` AS `current_quantity` from (((`obgm`.`product_inventory_pivot_view` join `obgm`.`product` on((`obgm`.`product`.`id` = `product_inventory_pivot_view`.`product_id`))) join `obgm`.`location` on((`obgm`.`location`.`id` = `product_inventory_pivot_view`.`location_id`))) left join `obgm`.`inventory_level` on(((`obgm`.`inventory_level`.`product_id` = `obgm`.`product`.`id`) and (`obgm`.`inventory_level`.`inventory_id` = `obgm`.`location`.`inventory_id`)))))""", fullDefinition: "false", remarks: "", viewName: "product_inventory_compare_view")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-634") {
        createView("""(select `obgm`.`location`.`id` AS `location_id`,`obgm`.`location`.`name` AS `location_name`,`bin`.`id` AS `bin_id`,`bin`.`name` AS `bin_name`,`obgm`.`product`.`id` AS `product_id`,`obgm`.`product`.`product_code` AS `product_code`,`obgm`.`product`.`name` AS `product_name`,`obgm`.`inventory_item`.`id` AS `inventory_item_id`,`obgm`.`inventory_item`.`lot_number` AS `lot_number`,`obgm`.`inventory_item`.`expiration_date` AS `expiration_date`,(to_days(`obgm`.`inventory_item`.`expiration_date`) - to_days(now())) AS `days_until_expiry`,`obgm`.`inventory_snapshot`.`quantity_on_hand` AS `quantity_on_hand` from ((((`obgm`.`inventory_snapshot` join `obgm`.`location` on((`obgm`.`inventory_snapshot`.`location_id` = `obgm`.`location`.`id`))) left join `obgm`.`location` `bin` on((`obgm`.`inventory_snapshot`.`bin_location_id` = `bin`.`id`))) join `obgm`.`inventory_item` on((`obgm`.`inventory_item`.`id` = `obgm`.`inventory_snapshot`.`inventory_item_id`))) join `obgm`.`product` on((`obgm`.`inventory_item`.`product_id` = `obgm`.`product`.`id`))) where (`obgm`.`inventory_snapshot`.`date` = (select max(`obgm`.`inventory_snapshot`.`date`) from `obgm`.`inventory_snapshot`)))""", fullDefinition: "false", remarks: "", viewName: "product_inventory_expiry_view")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-635") {
        createView("""(select `product_inventory_snapshot_view`.`product_id` AS `product_id`,`product_inventory_snapshot_view`.`location_id` AS `location_id`,`product_inventory_snapshot_view`.`date` AS `date`,(case when (`product_inventory_snapshot_view`.`date` = cast(curdate() as datetime)) then `product_inventory_snapshot_view`.`quantity_on_hand` end) AS `previous_quantity`,(case when (`product_inventory_snapshot_view`.`date` = cast((curdate() + 1) as datetime)) then `product_inventory_snapshot_view`.`quantity_on_hand` end) AS `current_quantity` from `obgm`.`product_inventory_snapshot_view`)""", fullDefinition: "false", remarks: "", viewName: "product_inventory_extended_view")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-636") {
        createView("""(select `product_inventory_extended_view`.`product_id` AS `product_id`,`product_inventory_extended_view`.`location_id` AS `location_id`,sum(`product_inventory_extended_view`.`previous_quantity`) AS `previous_quantity`,sum(`product_inventory_extended_view`.`current_quantity`) AS `current_quantity` from `obgm`.`product_inventory_extended_view` group by `product_inventory_extended_view`.`product_id`,`product_inventory_extended_view`.`location_id`)""", fullDefinition: "false", remarks: "", viewName: "product_inventory_pivot_view")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-637") {
        createView("""(select `obgm`.`inventory_snapshot`.`product_id` AS `product_id`,`obgm`.`inventory_snapshot`.`location_id` AS `location_id`,`obgm`.`inventory_snapshot`.`date` AS `date`,sum(`obgm`.`inventory_snapshot`.`quantity_on_hand`) AS `quantity_on_hand` from `obgm`.`inventory_snapshot` where (`obgm`.`inventory_snapshot`.`date` between cast(curdate() as datetime) and cast((curdate() + 1) as datetime)) group by `obgm`.`inventory_snapshot`.`date`,`obgm`.`inventory_snapshot`.`location_id`,`obgm`.`inventory_snapshot`.`product_id`)""", fullDefinition: "false", remarks: "", viewName: "product_inventory_snapshot_view")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-638") {
        createView("""(select `obgm`.`inventory_snapshot`.`location_id` AS `location_id`,`obgm`.`inventory_snapshot`.`product_id` AS `product_id`,`obgm`.`inventory_snapshot`.`date` AS `date`,sum(`obgm`.`inventory_snapshot`.`quantity_on_hand`) AS `quantity_on_hand` from `obgm`.`inventory_snapshot` where (`obgm`.`inventory_snapshot`.`date` = (select max(`obgm`.`inventory_snapshot`.`date`) from `obgm`.`inventory_snapshot`)) group by `obgm`.`inventory_snapshot`.`location_id`,`obgm`.`inventory_snapshot`.`product_id`,`obgm`.`inventory_snapshot`.`date`)""", fullDefinition: "false", remarks: "", viewName: "product_snapshot")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-639") {
        createView("""select `obgm`.`requisition`.`origin_id` AS `origin_id`,`obgm`.`requisition_item`.`product_id` AS `product_id`,ifnull(ceiling(sum(((`obgm`.`requisition_item`.`quantity` / `obgm`.`requisition`.`replenishment_period`) * 30))),0) AS `quantity_demand` from (`obgm`.`requisition_item` join `obgm`.`requisition` on((`obgm`.`requisition`.`id` = `obgm`.`requisition_item`.`requisition_id`))) where (`obgm`.`requisition`.`is_template` = TRUE) group by `obgm`.`requisition`.`origin_id`,`obgm`.`requisition_item`.`product_id`""", fullDefinition: "false", remarks: "", viewName: "product_stocklist")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-640") {
        createView("""(select `stockout_fact_tmp`.`product_id` AS `product_id`,`stockout_fact_tmp`.`location_id` AS `location_id`,(case when (`stockout_fact_tmp`.`stockout_days` > 21) then 'Stocked out 3-4 weeks' when (`stockout_fact_tmp`.`stockout_days` > 14) then 'Stocked out 2-3 weeks' when (`stockout_fact_tmp`.`stockout_days` > 7) then 'Stocked out 1-2 weeks' when (`stockout_fact_tmp`.`stockout_days` > 0) then 'Stocked out <1 week' when (`stockout_fact_tmp`.`stockout_days` = 0) then 'Never' end) AS `stockout_status` from (select `obgm`.`product_dimension`.`product_id` AS `product_id`,`obgm`.`location_dimension`.`location_id` AS `location_id`,count(`obgm`.`date_dimension`.`id`) AS `stockout_days` from (((`obgm`.`stockout_fact` join `obgm`.`date_dimension` on((`obgm`.`stockout_fact`.`date_dimension_id` = `obgm`.`date_dimension`.`id`))) join `obgm`.`product_dimension` on((`obgm`.`stockout_fact`.`product_dimension_id` = `obgm`.`product_dimension`.`id`))) join `obgm`.`location_dimension` on((`obgm`.`stockout_fact`.`location_dimension_id` = `obgm`.`location_dimension`.`id`))) where (`obgm`.`date_dimension`.`date` between (now() + interval -(30) day) and now()) group by `obgm`.`product_dimension`.`product_id`,`obgm`.`location_dimension`.`location_id`) `stockout_fact_tmp`)""", fullDefinition: "false", remarks: "", viewName: "product_stockout")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-641") {
        createView("""(select `product_summary`.`product_id` AS `product_id`,`product_summary`.`location_id` AS `location_id`,ifnull(`product_stockout`.`stockout_status`,'Never') AS `stockout_status` from (`obgm`.`product_summary` left join `obgm`.`product_stockout` on(((`product_summary`.`product_id` = `product_stockout`.`product_id`) and (`product_summary`.`location_id` = `product_stockout`.`location_id`)))))""", fullDefinition: "false", remarks: "", viewName: "product_stockout_status")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-642") {
        createView("""select `a`.`product_id` AS `product_id`,`a`.`location_id` AS `location_id`,(case when (min(`a`.`original_min_date`) > min(`a`.`substitution_min_date`)) then 'EARLIER' else (case when sum(`a`.`substitution_quantity_on_hand`) then 'YES' else 'NO' end) end) AS `substitution_status` from (select `p_a`.`product_id` AS `product_id`,`p_s`.`product_id` AS `associated_product_id`,`p_s`.`location_id` AS `location_id`,min(`original_inventory_item`.`expiration_date`) AS `original_min_date`,sum(distinct `p_s`.`quantity_on_hand`) AS `substitution_quantity_on_hand`,min(`subsitution_inventory_item`.`expiration_date`) AS `substitution_min_date` from (((`obgm`.`product_association` `p_a` left join `obgm`.`product_availability` `p_s` on((`p_s`.`product_id` = `p_a`.`associated_product_id`))) left join `obgm`.`inventory_item` `subsitution_inventory_item` on((`subsitution_inventory_item`.`id` = `p_s`.`inventory_item_id`))) left join `obgm`.`inventory_item` `original_inventory_item` on((`original_inventory_item`.`product_id` = `p_a`.`product_id`))) where ((`p_a`.`code` = 'SUBSTITUTE') and (`p_s`.`quantity_on_hand` > 0)) group by `p_a`.`product_id`,`p_a`.`associated_product_id`,`p_s`.`location_id`) `a` where ((`a`.`original_min_date` > `a`.`substitution_min_date`) or (`a`.`substitution_quantity_on_hand` > 0)) group by `a`.`product_id`,`a`.`location_id`""", fullDefinition: "false", remarks: "", viewName: "product_substitution_status")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-643") {
        createView("""select uuid_short() AS `id`,`obgm`.`product_availability`.`location_id` AS `location_id`,`obgm`.`product_availability`.`product_id` AS `product_id`,sum(`obgm`.`product_availability`.`quantity_on_hand`) AS `quantity_on_hand` from `obgm`.`product_availability` group by `obgm`.`product_availability`.`location_id`,`obgm`.`product_availability`.`product_id`""", fullDefinition: "false", remarks: "", viewName: "product_summary")
    }

    changeSet(author: "jmiranda (generated)", id: "1613884772808-644") {
        createView("""select `obgm`.`requisition_item`.`id` AS `id`,`obgm`.`requisition_item`.`requisition_item_type` AS `requisition_item_type`,`obgm`.`requisition_item`.`parent_requisition_item_id` AS `parent_requisition_item_id`,`obgm`.`requisition_item`.`requisition_id` AS `requisition_id`,`obgm`.`requisition`.`origin_id` AS `origin_id`,`obgm`.`requisition`.`destination_id` AS `destination_id`,`obgm`.`requisition_item`.`product_id` AS `product_id`,`obgm`.`product`.`product_code` AS `product_code`,`obgm`.`product`.`name` AS `name`,`obgm`.`requisition_item`.`quantity` AS `quantity`,`obgm`.`requisition_item`.`quantity_canceled` AS `quantity_canceled`,`obgm`.`requisition_item`.`order_index` AS `order_index`,`obgm`.`requisition_item`.`cancel_reason_code` AS `cancel_reason_code`,`obgm`.`requisition_item`.`comment` AS `comments`,(case when `modification_item`.`quantity` then `modification_item`.`quantity` when (`obgm`.`requisition_item`.`quantity_canceled` = `obgm`.`requisition_item`.`quantity`) then 0 else NULL end) AS `quantity_revised` from (((`obgm`.`requisition_item` join `obgm`.`requisition` on((`obgm`.`requisition_item`.`requisition_id` = `obgm`.`requisition`.`id`))) join `obgm`.`product` on((`obgm`.`product`.`id` = `obgm`.`requisition_item`.`product_id`))) left join `obgm`.`requisition_item` `modification_item` on(((`modification_item`.`parent_requisition_item_id` = `obgm`.`requisition_item`.`id`) and (`modification_item`.`requisition_item_type` = 'QUANTITY_CHANGE'))))""", fullDefinition: "false", remarks: "", viewName: "stock_movement_item")
    }
}
