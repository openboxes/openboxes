    ...
    CASE
        WHEN pis.transaction_id IS NULL THEN (
              COALESCE((
                  ...
                  WHERE pis.product_id = inventory_item.product_id
            ...
            +
             COALESCE((
                 ...
                 WHERE quantity_sum_for_adjustment.product_id = inventory_item.product_id
                 ...
                 AND quantity_sum_for_adjustment.transaction_date > (
                    ...
                    WHERE product_inventory_summary.product_id = inventory_item.product_id
