...
SELECT a.product_id, a.destination_id, sum(a.quantity_ordered) - sum(a.quantity_shipped) as quantity_ordered_not_shipped , null as quantity_shipped_not_received FROM (
SELECT
