...
SELECT c.product_id, c.destination_id, null as quantity_ordered_not_shipped, (sum(c.quantity_shipped) - (sum(c.quantity_received) + sum(c.quantity_canceled))) as quantity_shipped_not_received
FROM (
SELECT
