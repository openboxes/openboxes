...
class IndicatorDataService {
    ...
    GraphData getExpirationSummaryData(Location location, def params) {
        ...
        for (int i = 0; i < querySize; i++) {
            ...
            String label = (i == 0) ? "react.default.dashboard.labels.timeline.today" : "react.default.dashboard.labels.timeline.within${daysCounter}Days"
            def monthLabel = [
            code : label,
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.expirationSummaryData",
            message : messageService.getMessage("react.default.dashboard.indicatorData.expirationSummaryData")
        ]
    ...
    GraphData getFillRate(Location location, def destination, def params) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.fillRate",
            message : messageService.getMessage("react.default.dashboard.indicatorData.fillRate")
        ]
    ...
    GraphData getFillRateSnapshot (Location origin, def params) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.fillRateSnapshot",
            message : messageService.getMessage("react.default.dashboard.indicatorData.fillRateSnapshot")
        ]
    ...
    GraphData getInventorySummaryData(def location) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.inventorySummaryData",
            message : messageService.getMessage("react.default.dashboard.indicatorData.inventorySummaryData")
        ]
    ...
    GraphData getSentStockMovements(Location location, def params) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.sentStockMovements",
            message : messageService.getMessage("react.default.dashboard.indicatorData.sentStockMovements")
        ]
    ...
    GraphData getReceivedStockData(Location location, def params) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.receivedStockData",
            message : messageService.getMessage("react.default.dashboard.indicatorData.receivedStockData")
        ]
    ...
    GraphData getOutgoingStock(Location location) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.outgoingStock",
            message : messageService.getMessage("react.default.dashboard.indicatorData.outgoingStock")
        ]
    ...
    GraphData getIncomingStock(Location location) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.incomingStock",
            message : messageService.getMessage("react.default.dashboard.indicatorData.incomingStock")
        ]
    ...
    GraphData getDiscrepancy(Location location, def params) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.discrepancy",
            message : messageService.getMessage("react.default.dashboard.indicatorData.discrepancy")
        ]
    ...
    GraphData getDelayedShipments(Location location) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.delayedShipments",
            message : messageService.getMessage("react.default.dashboard.indicatorData.delayedShipments")
        ]
    ...
    GraphData getProductsInventoried(Location location) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.productsInventoried",
            message : messageService.getMessage("react.default.dashboard.indicatorData.productsInventoried")
        ]
    ...
    GraphData getLossCausedByExpiry(Location location, def params) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.lossCausedByExpiry",
            message : messageService.getMessage("react.default.dashboard.indicatorData.lossCausedByExpiry")
        ]
        GraphData graphData = new GraphData(
            indicatorData,
            title,
    ...
    GraphData getPercentageAdHoc(Location location) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.percentageAdHoc",
            message : messageService.getMessage("react.default.dashboard.indicatorData.percentageAdHoc")
        ]
    ...
    GraphData getStockOutLastMonth(Location location) {
        ...
        def title = [
            code : "react.default.dashboard.indicatorData.stockOutLastMonth",
            message : messageService.getMessage("react.default.dashboard.indicatorData.stockOutLastMonth")
        ]
