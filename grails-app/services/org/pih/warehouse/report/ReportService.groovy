    ...
    def parseItemsForAmountOutstandingOnOrdersReport(List results) {
        ...
        results.collect { result ->
            ...
            def printRow = [
                ...
                "Description"                                       : orderItem?.product?.description ?: orderItem?.product?.displayNameOrDefaultName,
    ...
    def parseAdjustmentsForAmountOutstandingOnOrdersReport(List results) {
        ...
        results.collect { result ->
            ...
            def printRow = [
                ...
                "Description"                                       : orderAdjustment?.description ?: orderAdjustment?.orderItem?.product?.displayNameOrDefaultName,
                "UOM"                                               : "",
