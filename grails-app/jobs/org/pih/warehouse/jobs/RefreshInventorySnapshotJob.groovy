...
class RefreshInventorySnapshotJob {
    ...
    void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (enabled) {
            ...
            Integer maxRetryAttempts = ConfigurationHolder.config.openboxes.jobs.refreshInventorySnapshotJob.maxRetryAttempts ?: 5
            if (retryCount > 0) {
                log.warn "Retry count: ${retryCount} / ${maxRetryAttempts}"
            }
