...
class TemporalAccessorDateTimeFormatterSpec extends Specification {
    ...
    void 'format succeeds when given a display format for scenario: #scenario'() {
        ...
        Locale.ENGLISH | DateDisplayFormat.CSV  | '+01:00' || '2000-01-01'                | 'CSV format localization (english) UTC+1'
        Locale.ITALIAN | DateDisplayFormat.CSV  | '+01:00' || '2000-01-01'                | 'CSV format localization (non-english) UTC+1'
