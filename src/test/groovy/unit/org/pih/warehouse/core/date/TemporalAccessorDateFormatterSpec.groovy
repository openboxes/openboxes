...
class TemporalAccessorDateFormatterSpec extends Specification {
    ...
    void 'format succeeds when given a display format for scenario: #scenario'() {
        ...
        Locale.ENGLISH | DateDisplayFormat.CSV  || '2000-01-01'   | 'CSV format localization in english'
        Locale.ITALIAN | DateDisplayFormat.CSV  || '2000-01-01'   | 'CSV format localization in non-english'
