...
class LocalizationUtilTest {
	...
	void testIsSpanishMexico() {
		...
		assert LocalizationUtil.isSpanishMexico(spanishMexico)

		assert !LocalizationUtil.isSpanishMexico(english)

        assert !LocalizationUtil.isSpanishMexico(spanish)
	}
}
