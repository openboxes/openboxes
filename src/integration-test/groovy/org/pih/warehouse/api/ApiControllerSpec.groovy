...
class ApiControllerSpec extends Specification {
    ...
    def setup() {
        ...
        Organization organization = new Organization(code: "MAIN", name: "Main Company", partyType: orgPartyType)
        organization.save()
        LocationType defaultLocationType = LocationType.findByLocationTypeCode(LocationTypeCode.DEPOT)
        location = new Location(code: "MAIN", name: "Main Warehouse", locationType: defaultLocationType, organization: organization)
        location.save()
    }
    ...
    void "get app context should return data"() {
        ...
        controller.session.location = Location.findByLocationNumber("MAIN")
