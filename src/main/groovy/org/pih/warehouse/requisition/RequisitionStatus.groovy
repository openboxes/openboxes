...
enum RequisitionStatus {
    ...
    STAGED(11, null, StatusType.SUCCESS),
    ISSUED(12, null, StatusType.SUCCESS),
    ...
    static listOutboundOptions() {
        [CREATED, EDITING, VERIFYING, PICKING, PICKED, CHECKING, STAGED, ISSUED, CANCELED]
    }
    ...
    static listOutboundOptionsWhenApprovalRequired() {
        [CREATED, VERIFYING, APPROVED, EDITING, PICKING, PICKED, CHECKING, STAGED, ISSUED, CANCELED]
    }

    // Subset of listOutboundOptions() without ISSUED and CANCELED, as those are not in progress statuses
    static listOutboundInProgress() {
        [CREATED, EDITING, VERIFYING, PICKING, PICKED, CHECKING]
    }

    // Subset of listOutboundOptionsWhenApprovalRequired() without ISSUED and CANCELED, as those are not in progress statuses
    static listOutboundInProgressWhenApprovalRequired() {
        [CREATED, VERIFYING, APPROVED, EDITING, PICKING, PICKED, CHECKING]
    }
    ...
    static listPending() {
        [CREATED, EDITING, VERIFYING, PICKING, PICKED, STAGED, CHECKING, PENDING, REQUESTED, APPROVED, PENDING_APPROVAL]
    }
