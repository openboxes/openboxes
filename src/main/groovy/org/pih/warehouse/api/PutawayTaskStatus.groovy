...
enum PutawayTaskStatus {
    ...
    static final Map<PutawayTaskStatus, Set<PutawayTaskStatus>> ALLOWED_STATE_TRANSITIONS = [
            (PENDING)    : [STARTED, IN_PROGRESS, COMPLETED, CANCELED] as Set,
            (STARTED)    : [IN_PROGRESS, COMPLETED, CANCELED] as Set,
            (IN_PROGRESS): [COMPLETED, CANCELED] as Set,
            (COMPLETED)  : [] as Set,
            (CANCELED)   : [] as Set,
    ]
