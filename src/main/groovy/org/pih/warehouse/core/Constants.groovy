...
class Constants {
    ...
    static final String ISO_DATE_TIME_WITH_TIMEZONE_OFFSET_FORMAT = "yyyy-MM-dd'T'HH:mm:ssXXX"
    ...
    static final String INVENTORY_SHORTFALL_LOCATION_TYPE_ID = "INVENTORY_SHORTFALL_LOCATION"
