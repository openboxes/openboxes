...
enum ActivityCode {
    ...
    ORDER_ALLOCATION_STRATEGY_DISPLAY_FIRST('DISPLAY_FIRST'),
    ORDER_ALLOCATION_STRATEGY_STORAGE_FIRST('STORAGE_FIRST'),
    ORDER_ALLOCATION_STRATEGY_CROSS_DOCK('CROSS_DOCK'), // this is for later so we know when an item has been allocated via cross dock
    ...
    DELIVERY_TYPE_FACILITY_TRANSFER('DELIVERY_TYPE_FACILITY_TRANSFER'),
    ...
    static list() {
        [
                ...
                DELIVERY_TYPE_FACILITY_TRANSFER,
