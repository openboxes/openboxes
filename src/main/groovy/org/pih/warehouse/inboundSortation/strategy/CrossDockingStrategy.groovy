...
/**
 ...
 where the cross-dock instruction is provided (through integration).
 That strategy is available in org.pih.warehouse.inboundSortation.strategy.CrossDockingBackorderReferencePutawayStrategy.
 */
@Deprecated
