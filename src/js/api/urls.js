...
export const CYCLE_COUNT_START = (locationId, format) => `${CYCLE_COUNT(locationId)}/start/batch?format=${format ?? 'json'}`;
export const CYCLE_COUNT_RECOUNT_START = (locationId, format) => `${CYCLE_COUNT(locationId)}/recount/start/batch?format=${format ?? 'json'}`;
