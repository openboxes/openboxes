...
export const getPartialReceivingTranslationsFetched = createSelector(
  [getSession],
  (session) => session.fetchedTranslations.partialReceiving,
);
...
export const getCycleCountReasonCodes = createSelector(
  [getCycleCount],
