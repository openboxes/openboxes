  ...
  handleSubmit(values) {
    ...
    apiClient.post(`/openboxes/api/locations/${values.id}`, {
      ...
      .then((res) => {
        ...
        this.props.editLocation(res.data.data, 'ZONE');
        this.props.setShowEditZoneModal();
      })
      .catch(() => {
        this.props.hideSpinner();
              ...
              <form onSubmit={handleSubmit} className="w-100">
                <div className="classic-form with-description add-zone-modal-form">
                  <div className="form-title">
                    <Translate id="react.locationsConfiguration.editZone.label" defaultMessage="Edit Zone Location" />
                  </div>
                  ...
                  <div className="submit-buttons d-flex justify-content-between">
                    <button type="button" className="btn btn-outline-primary" onClick={this.props.setShowEditZoneModal}>Cancel</button>
...
EditZoneModal.propTypes = {
  setShowEditZoneModal: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, mapDispatchToProps)(EditZoneModal);
