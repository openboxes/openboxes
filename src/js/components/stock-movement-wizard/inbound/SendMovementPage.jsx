...
class SendMovementPage extends Component {
  ...
  /**
   * Updates stock movement status to SENT with post method.
   * @public
   */
            ...
            <form onSubmit={handleSubmit}>
              <div className="d-flex">
                <div id="stockMovementInfo" style={{ flexGrow: 2 }}>
                  {_.map(SHIPMENT_FIELDS, (fieldConfig, fieldName) =>
                    renderFormField(fieldConfig, fieldName, {
                      canBeEdited: values.statusCode === 'SENT' && values.shipmentStatus !== 'PARTIALLY_RECEIVED' && values.shipmentStatus !== 'RECEIVED',
                      issued: values.statusCode === 'SENT',
                ...
                <div className="print-buttons-container col-md-3 flex-grow-1">
                  ...
                  <div className="dropzone btn btn-outline-secondary">
                    <Dropzone
                      disabled={values.statusCode === 'SENT'}
                      onDrop={this.onDrop}
                      multiple
                    >
              ...
              <div>
                ...
                <button
                  ...
                  disabled={invalid || values.statusCode === 'SENT'}
