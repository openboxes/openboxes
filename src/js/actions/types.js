...
export const START_FETCHING_TRANSLATIONS = 'START_FETCHING_TRANSLATIONS';
...
export const UPDATE_RECEIVING_BIN_LOCATIONS = 'UPDATE_RECEIVING_BIN_LOCATIONS';
export const UPDATE_RECEIVING_VIEW = 'UPDATE_RECEIVING_VIEW';
export const UPDATE_RECEIVING_SORT = 'UPDATE_RECEIVING_SORT';
export const RESET_RECEIVING_SORT = 'RESET_RECEIVING_SORT';
export const UPDATE_RECEIVING_DATE_DELIVERED = 'UPDATE_RECEIVING_DATE_DELIVERED';
export const UPDATE_RECEIVING_PUTAWAY_ENABLED = 'UPDATE_RECEIVING_PUTAWAY_ENABLED';
export const REMOVE_RECEIVING_PUTAWAY_ENABLED = 'REMOVE_RECEIVING_PUTAWAY_ENABLED';

// Cycle count
export const START_COUNT = 'START_COUNT';
export const START_RESOLUTION = 'START_RESOLUTION';
export const FETCH_CYCLE_COUNT_REASON_CODES = 'FETCH_CYCLE_COUNT_REASON_CODES';
...
export const CLEAR_COUNT_WORKFLOW = 'CLEAR_COUNT_WORKFLOW';

// VALIDATION ERRORS
export const SET_ERRORS = 'SET_ERRORS';
export const SET_ERRORS_BY_ID = 'SET_ERRORS_BY_ID';
export const SUBMIT_FORM = 'SUBMIT_FORM';
export const CLEAR_ERRORS_DATA = 'CLEAR_ERRORS_DATA';
