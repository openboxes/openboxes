...
export function fetchIndicators() {
  return (dispatch) => {
    ...
    fetchIndicator(dispatch, 'getOutgoingStock', 'numbers', 'Outgoing Stock Movements in Progress', '/openboxes/stockMovement/list?receiptStatusCode=PENDING&origin.id=');
  };
}
