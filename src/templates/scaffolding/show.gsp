...
<html>
	...
	<body>
		...
		<div id="show-${domainClass.propertyName}" class="content scaffold-show box" role="main">
			...
			<g:form url="[resource:${propertyName}, action:'delete']" method="DELETE">
				<div class="buttons">
					<g:link class="edit button" action="edit" resource="\${${propertyName}}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
